...
public class Plane extends JComponent{
	...
	protected void paintComponent(Graphics g) {
		...
		AffineTransform center = new AffineTransform(new double[] {1,0,0,-1,this.getWidth()/2,this.getHeight()/2});
		center.concatenate(original);
		
		// converts image to standard coordinate plane centered at the center of the window
